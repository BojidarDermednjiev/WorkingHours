    ...
    <section class="h-screen w-screen">
      <div class="container h-full py-24">
        <div class=" flex h-full  items-center justify-center w-full">
          ...
          <div class="md:w-8/12 lg:ml-6 lg:w-4/12">
            <form>
              <section className="grid mb-6 gap-y-4">
                {/* <!-- Email input --> */}
                <GoogleInput label="Email" name="name" />
                {/* <!-- Password input --> */}
                <GoogleInput label="Password" name="password" />
              </section>
              ...
              <div className="flex w-full gap-4 ">
                <Button size="lg" color="blue" fullWidth>Sign in</Button>
              </div>
              {/* <!-- Divider --> */}
